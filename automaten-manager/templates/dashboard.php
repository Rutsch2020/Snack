    ...
    <div class="am-container">
        ...
        <div class="am-grid am-grid-4 am-animate">
            <div class="am-stat-card">
                ...
                <div class="am-stat-trend">
                    <i class="fas fa-arrow-up"></i> 12% seit letzter Woche
                </div>
            </div>
            ...
            <div class="am-stat-card" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
                ...
                <div class="am-stat-trend">
                    <i class="fas fa-arrow-up"></i> 8% Wertsteigerung
                </div>
            </div>
        ...
        <div class="am-grid am-grid-2" style="margin-top: 2rem;">
            <div class="am-card am-animate">
                ...
                <div class="am-recent-items">
                    <div class="am-recent-item">
                        <div class="am-recent-icon" style="background: #3498db20; color: #3498db;">
                            <i class="fas fa-coffee"></i>
                        </div>
                        <div class="am-recent-details">
                            <h4>Coca Cola 0.5L</h4>
                            <p>Vor 2 Stunden hinzugefügt</p>
                        </div>
                        <div class="am-recent-price">€1.50</div>
                    </div>
                    <div class="am-recent-item">
                        <div class="am-recent-icon" style="background: #e74c3c20; color: #e74c3c;">
                            <i class="fas fa-cookie"></i>
                        </div>
                        <div class="am-recent-details">
                            <h4>Snickers</h4>
                            <p>Vor 5 Stunden hinzugefügt</p>
                        </div>
                        <div class="am-recent-price">€1.20</div>
                    </div>
                    <div class="am-recent-item">
                        <div class="am-recent-icon" style="background: #f39c1220; color: #f39c12;">
                            <i class="fas fa-candy-cane"></i>
                        </div>
                        <div class="am-recent-details">
                            <h4>Haribo Goldbären</h4>
                            <p>Gestern hinzugefügt</p>
                        </div>
                        <div class="am-recent-price">€1.00</div>
                    </div>
                </div>
            </div>
            ...
            <div class="am-card am-animate">
                ...
                <div class="am-system-status">
                    ...
                    <div class="am-status-item">
                        <div class="am-status-indicator am-status-warning"></div>
                        <div class="am-status-details">
                            <h4>E-Mail Service</h4>
                            <p>Konfiguration ausstehend</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="am-card am-animate" style="margin-top: 2rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
            ...
            <div class="am-grid am-grid-3" style="margin-top: 1.5rem;">
                ...
                <div class="am-feature-preview">
                    <i class="fas fa-calendar-alt fa-3x" style="opacity: 0.8;"></i>
                    <h3>Haltbarkeits-Tracking</h3>
                    <p>Automatische MHD-Verwaltung</p>
                    <span class="am-badge">Demnächst</span>
                </div>
                <div class="am-feature-preview">
...
jQuery(document).ready(function($) {
    ...
    $('#am-header-quick-scan').on('click', function(e) {
        e.preventDefault();
        // Call initScanner from scanner.js
        if (typeof initScanner === 'function') {
            initScanner();
        } else {
            console.error('Scanner JS nicht geladen. Kann Scanner nicht starten.');
            showNotification('Scanner ist nicht verfügbar. Bitte lade die Seite neu.', 'error');
            // Fallback: direct link to scanner page if JS is completely broken
    ...
    $('#am-dashboard-scanner').on('click', function(e) {
        ...
        if (typeof initScanner === 'function') {
            ...
            console.error('Scanner JS nicht geladen. Kann Scanner nicht starten.');
            showNotification('Scanner ist nicht verfügbar. Bitte lade die Seite neu.', 'error');
            // Fallback: direct link to scanner page
            // window.location.href = automatenManager.adminUrl + 'admin.php?page=am-scanner';
        }
    });

    // Inventory Scanner (assuming it also opens the scanner for inventory mode)
    ...
    $('#am-quick-barcode-submit').on('click', function() {
        ...
        if (barcode) {
            // Trigger the global barcode detection handler, indicating manual input
            if (typeof handleBarcodeDetected === 'function') {
                handleBarcodeDetected(barcode, true); // true for manual input
            } else {
                console.error('handleBarcodeDetected nicht geladen.');
                showNotification('Scanner-Logik nicht verfügbar.', 'error');
            }
        } else {
            showNotification('Bitte gib einen Barcode ein.', 'error'); // Use global notification
        }
    });
